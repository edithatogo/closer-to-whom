...
def synthetic_scenarios() -> tuple[Scenario, ...]:
    ...
    return (
        ...
        Scenario(
            ...
            allowed_delivery_modes=frozenset({DeliveryMode.IV_HOSPITAL, DeliveryMode.IV_SATELLITE}),
            allowed_formulations=frozenset({Formulation.TRASTUZUMAB_IV}),
        ...
        Scenario(
            ...
            allowed_formulations=frozenset({Formulation.TRASTUZUMAB_SC, Formulation.PHESGO_SC}),
            evidence_grade_threshold=2,
        ),
        Scenario(
